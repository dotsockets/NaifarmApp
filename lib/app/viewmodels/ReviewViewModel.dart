  ...
  List<ReviewModel> getReviewByProduct() {
    return [
      ReviewModel(
          ...
          reviewRate: 3.5,
          reviewComment:
              "ถ้าพูดถึงกระเป๋าผ้าลายดอก จะไม่พูดถึงแบรนด์นี้ไม่ได้เลย",
          imageReview: [
  ...
  List<FollowersModel> getFollower() {
    return [
      ...
      FollowersModel(
          name: "ข้าวสารลุงชัย",
          image:
              "https://www.donegallive.ie/resizer/420/315/true/GN4_DAT_16732044.jpg--man_about_town__a_beginner_s_guide_to_manscaping.jpg",
          isFollow: true),
      FollowersModel(
          name: "น้ำตาลสดแม่ม้อย",
          image:
              "https://haircutinspiration.com/wp-content/uploads/Chris-Evans-buzz-cut-e1538974047133.jpg",
          isFollow: false),
      FollowersModel(
          name: "อรุ่นรุ่ง",
          image:
              "https://pyxis.nymag.com/v1/imgs/cb0/25e/b034bbead413429c1b8baec32768f07a85-man-in-mask.rsquare.w1200.jpg",
          isFollow: false),
      FollowersModel(
          name: "ร้านผักสวย",
          image:
              "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQh-4dAifqVHDD4pA2EzQiZn1AkCfa82Yw1NQ&usqp=CAU",
          isFollow: false),
      FollowersModel(
          name: "ผลไม้สวนสวย",
          image:
              "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQTQA96SxawYMeBsSgl3QG3wFhY2Sgp-mkLmw&usqp=CAU",
          isFollow: false),
      FollowersModel(
          name: "อุปกรณ์ครัว",
          image:
              "https://i1.adis.ws/i/canon/canon-pro-woman-hub-hero-1040x680?w=1146&qlt=70&fmt=jpg&fmt.options=interlaced&bg=rgb(255,255,255)",
          isFollow: false),
      FollowersModel(
          name: "ITnew",
          image:
              "https://www.online-station.net/pic/X2NvbnRlbnQvMjAxOC8wNzIyL3RodW1ibmFpbC8xMTQ4NDFfMDk0NDM2LmpwZyZ3PTExNDAmaD01OTc",
          isFollow: false)
    ];
  }
}
