...
class CartBankMobile extends StatefulWidget {
  @override
  _CartBankMobileState createState() => _CartBankMobileState();
}

class _CartBankMobileState extends State<CartBankMobile> {
