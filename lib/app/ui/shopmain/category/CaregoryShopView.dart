          ...
          Container(
            ...
            child:  Row(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text("${Random().nextInt(100)} "+LocaleKeys.shop_product_list.tr(),style: FunctionHelper.FontTheme(fontWeight: FontWeight.w500,fontSize: SizeUtil.detailFontSize(),color: Colors.black.withOpacity(0.5))),
                    SizedBox(width: 10),
