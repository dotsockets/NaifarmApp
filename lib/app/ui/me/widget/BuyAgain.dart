...
class BuyAgain extends StatelessWidget {
    ...
    return SingleChildScrollView(
      child: Container(
        ...
        child: Column(
          ...
          children: [_headerBar(), _flashProduct()],
        ),
      ),
    );
  }
  ...
  Container _headerBar() => Container(
        ...
        margin: EdgeInsets.only(
            right: 1.5.w, left: 3.5.w, top: 1.5.h, bottom: 0.5.h),
        child: Row(
          ...
          children: [
            ...
            GestureDetector(
                child: Row(
                  children: [
                    Text(LocaleKeys.me_message_other.tr(),
                        style: FunctionHelper.fontTheme(
                            color: Colors.black,
                            fontSize: SizeUtil.titleFontSize().sp,
                            fontWeight: FontWeight.bold)),
        ...
        children: List.generate(productRespone.data.length, (index) {
          return GestureDetector(
            child: Container(
              ...
              child: Column(
                children: [
                  productImage(item: productRespone.data[index], index: index),
  ...
  Widget productImage({ProductData item, int index}) {
    return ClipRRect(
