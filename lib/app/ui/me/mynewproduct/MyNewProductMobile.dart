...
class MyNewProductMobile extends StatefulWidget {
  @override
  _MyNewProductState createState() => _MyNewProductState();
}

class _MyNewProductState extends State<MyNewProductMobile> {
  @override
  void initState() {
    super.initState();
  }
