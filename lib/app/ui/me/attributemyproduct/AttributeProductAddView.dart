...
class AttributeProductAddView extends StatefulWidget {
  final ProductShopItemRespone productMyShopRespone;

  const AttributeProductAddView({Key key, this.productMyShopRespone})
      : super(key: key);

  @override
  _AttributeProductAddViewState createState() =>
      _AttributeProductAddViewState();
}

class _AttributeProductAddViewState extends State<AttributeProductAddView> {
        ...
        children: [
          ...
          Expanded(
            ...
            child: CustomDropdownList(
              txtSelect: nameAttr != -1
                  ? item.data[nameAttr].name
                  : LocaleKeys.select.tr() + LocaleKeys.attributes_label.tr(),
