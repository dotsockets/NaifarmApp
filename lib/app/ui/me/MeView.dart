                           ...
                           SliverAppBar(
                             leading: Container(
                               ...
                               child: GestureDetector(
                                 ...
                                 onTap: () async {
                                   final result = await AppRoute.SettingProfile(context, IsLogin,item: info.customerInfoRespone);
                                   ...
                                   children: [
                                     ...
                                     ClipRRect(
                                       ...
                                       child: CachedNetworkImage(
                                         ...
                                         fit: BoxFit.cover,
                                         imageUrl:info.customerInfoRespone!=null?info.customerInfoRespone.image.length>0?"${Env.value.baseUrl}/storage/images/${info.customerInfoRespone.image[0].path}":'':'',
                                     ...
                                     Text(info.customerInfoRespone!=null?info.customerInfoRespone.name:"ฟาร์มมาร์เก็ต",
                                 ...
                                 child: DefaultTabController(
                                  ...
                                  indicatorColor: ThemeColor.ColorSale(),
                                         ...
                                         Expanded(
                                           child: TabBarView(
                                             children: [
                                               PurchaseView(IsLogin: IsLogin,item:info.customerInfoRespone,onStatus: (bool status){
                                                 if(status){
                                                   Usermanager().getUser().then((value) =>bloc.loadMyProfile(token: value.token));
                                                 }
                                               }, ),
                                               MyshopView(IsLogin: IsLogin,scaffoldKey: _scaffoldKey,customerInfoRespone: info.customerInfoRespone,myShopRespone:info.myShopRespone,onStatus: (bool status){
                                                 if(status){
                                                   Usermanager().getUser().then((value) =>bloc.loadMyProfile(token: value.token));
                                                 }
                                               },)
