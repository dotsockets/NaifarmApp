...
class AvailableSearch extends StatefulWidget {
  final int shopId;
  final GlobalKey<ScaffoldState>  scaffoldKey;
  final String searchTxt;

  const AvailableSearch({Key key, this.shopId, this.scaffoldKey,this.searchTxt}) : super(key: key);

  @override
  _AvailableSearchState createState() => _AvailableSearchState();
}

class _AvailableSearchState extends State<AvailableSearch> {
  int limit = 5;
