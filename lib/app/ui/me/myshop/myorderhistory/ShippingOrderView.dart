...
class ShippingOrderView extends StatelessWidget {
        ...
        child: Scaffold(
          ...
          body: Container(
            child: Column(
              ...
              children: <Widget>[
                itemInfo(
                    icon: FontAwesome.inbox,
                    title: "Drop Off",
                    subtitle:
                        "คุณสามารถทำการ Drop Off พัสดุของคุณได้ที่ J&T Express สาขาใกล้บ้านคุณ",
                    onclick: () {
                ...
                itemInfo(
                    ...
                    title: "นัดรับสินค้า",
                    subtitle:
                        "เจ้าหน้าที่ J&T Express จะเข้ารับพัสดุที่ที่อยู่ในการนัดรับสินค้าของคุณ"),
                Container(
                  padding: EdgeInsets.all(2.5.w),
                  child: Text(
  ...
  Widget itemInfo(
      {IconData icon, String title, String subtitle = "", Function() onclick}) {
    return Container(
