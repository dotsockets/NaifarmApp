...
class ShopProfileView extends StatelessWidget with RouteAware{
  ...
  void _init(BuildContext context) {
    if (null == bloc) {
      _getCustomerInfo(context);
      bloc = MemberBloc(AppProvider.getApplication(context));
      _getCusStorage(context);
  ...
  void onSave(BuildContext context,{MyShopRespone itemInfo, bool onLoad = true}) {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        onSave(context,itemInfo: itemInfo, onLoad: true);
        return true;
      },
      child: Container(
              ...
              body: BlocBuilder<InfoCustomerBloc, InfoCustomerState>(
                builder: (_, item) {
                  if (item is InfoCustomerLoaded) {
                    ...
                    return contentMe(context,itemInfo: itemInfo);
  ...
  Widget contentMe(BuildContext context,{MyShopRespone itemInfo}) {
  ...
  _getCusStorage(BuildContext context){
  ...
  _getCustomerInfo(BuildContext context){
    Usermanager().getUser().then((value) => context
        .read<InfoCustomerBloc>()
        .loadCustomInfo(context, token: value.token));
  }
  _loadCusData(BuildContext context){
    Usermanager().getUser().then((value) => context
