...
class _OfficialNameViewState extends State<OfficialNameView> {
    ...
    return Container(
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          appBar: AppToobar(isEnable_Search: false,title: "แก้ไขชื่อทางการ",header_type: Header_Type.barNormal,),
          body: Container(
            child: Container(
              child: Column(
                children: [
  ...
  Widget _Form(){
    return Container(
      ...
      child: Column(
        children: [
          BuildEditText(head: "ชื่อเป็นทางการ",hint: "ระบุชื่อทางการ",inputType: TextInputType.text,BorderOpacity: 0.2,maxLength: 20,borderRadius: 5,onError: onError1,controller: _input1,onChanged: (String char){
            setState(() {
