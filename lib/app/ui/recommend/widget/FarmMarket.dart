...
class FarmMarket extends StatelessWidget {
  final List<ProductModel> _producViewModel = ProductViewModel().getProductFarm();
  @override
    ...
    child: Container(
      ...
      child: Row(
        ...
        children: [
          Row(
            children: [
              SvgPicture.asset('assets/images/svg/menu_market.svg',width: 50,height: 50,),
              SizedBox(width: 8),
              Text("ฟาร์มมาร์เก็ต",style: GoogleFonts.sarabun(color: Colors.black,fontSize: 18,fontWeight: FontWeight.bold)),
            ],
          ),
          Row(
            children: [
