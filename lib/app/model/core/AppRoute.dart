...
class AppRoute{
  ...
  static Future<bool> SettingProfile(BuildContext context) async {
    return await Navigator.push(context, PageTransition(duration: Duration(milliseconds: 300),type: PageTransitionType.fade, child: SettingProfileView()));
  }
  ...
  Navigator.push(context, PageTransition(duration: Duration(milliseconds: 300),type: PageTransitionType.fade, child:SearchMyProduct(shopID:shopID,tabNum: tabNum,)));
  }
  ...
  static Future<bool>  OrderCancle({BuildContext context,OrderData orderData}) async {

    return  await Navigator.push(context, PageTransition(duration: Duration(milliseconds: 300),type: PageTransitionType.fade, child:OrderCancleView(orderData: orderData)));
