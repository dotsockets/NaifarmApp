...
class AssetImages {
  ...
  AssetImages.fromJson(Map<String, dynamic> json) {
    ...
    _name = json['_name'];
    _originalWidth = json['_originalWidth'];
    _originalHeight = json['_originalHeight'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['_originalWidth'] = this._originalWidth;
    data['_originalHeight'] = this._originalHeight;
    return data;
  }
